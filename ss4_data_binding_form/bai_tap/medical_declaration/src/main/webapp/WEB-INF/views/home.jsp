...
<body>
    ...
    <form:form method="post" action="/currentForm" modelAttribute="medicalDeclaration">
        ...
        <div class="mt-3 mx-3">
            <input type="submit" value="Sending Declaration" class="bg-warning rounded-pill text-center">
        </div>
