...
<body>
    <form method="post" action="/sandwich" class="mt-5 ms-5">
        ...
        <div class="mb-3">
            <input class="form-control" id="disabledInput" type="text" value="The condiments that you selected are<c:forEach var="condiment" items="${condiments}"><c:out value=" ${condiment}"/></c:forEach>" disabled>
        </div>
